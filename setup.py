...
install_requires = [
    ...
    'invenio-base>=1.0.1',
    'invenio-cache>=1.0.0',
    'invenio-celery>=1.0.0,<1.1.1',
    'invenio-communities==1.0.0a19',
    'invenio-config>=1.0.0',
    'invenio-db[postgresql,versioning]>=1.0.0,<1.0.3',
