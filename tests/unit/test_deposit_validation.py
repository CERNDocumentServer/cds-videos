...
def test_missing_fields(
    es, location, project_deposit_metadata, video_deposit_metadata, remove_key, loader
):
...
def test_unknown_fields(
    es, project_deposit_metadata, video_deposit_metadata, location, add_key, loader
):
