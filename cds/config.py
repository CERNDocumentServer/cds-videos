...
THEOPLAYER_BASE_URL = "https://cdn.myth.theoplayer.com/"
...
CDS_OPENCAST_API_ENDPOINT_INGEST = "{host}/ingest".format(
    host=CDS_OPENCAST_HOST
)  # noqa
CDS_OPENCAST_API_ENDPOINT_EVENTS = "{host}/api/events".format(
    host=CDS_OPENCAST_HOST
)  # noqa
CDS_OPENCAST_API_ENDPOINT_VERIFY_CERT = False
CDS_OPENCAST_STATUS_CHECK_TASK_TIMEOUT = 5*60
CDS_OPENCAST_DOWNLOAD_TASK_TIMEOUT = 30*60
