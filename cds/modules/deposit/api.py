...
class Video(CDSDeposit):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._symlinks_creator = self.SymlinksCreator()
    ...
    def publish(self, pid=None, id_=None, **kwargs):
        ...
        self._symlinks_creator.create(previous_record, record_new)
    ...
    class SymlinksCreator(object):
        ...
        def create(self, prev_record, new_record):
            ...
            if prev_record:
                self._delete_prev_symlink(prev_record,
        ...
        def _build_link_path(symlinks_location, record, filename):
            ...
            return os.path.join(symlinks_location,
                                record['type'],
                                record['category'],
                                str(year),
                                report_number,
